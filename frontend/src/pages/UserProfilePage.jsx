  ...
  return (
    <main className="min-h-screen bg-white pb-24 md:pb-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4 px-3 py-2.5 sm:px-6 sm:py-4 md:px-8 md:py-6">
        ...
        <div className="grid items-start gap-4 lg:grid-cols-[360px_minmax(0,1fr)] xl:grid-cols-[380px_minmax(0,1fr)]">
          <Stack className="lg:sticky lg:top-24">
          ...
          <MobileCard className="overflow-hidden p-0">
            ...
            <div className="grid divide-y divide-neutral-100 lg:grid-cols-2 lg:divide-x lg:divide-y-0 xl:grid-cols-2">
