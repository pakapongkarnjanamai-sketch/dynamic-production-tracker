...
export const getLineWithProcesses = (id) =>
  request(`/api/lines/${id}/processes`);
export const createLine = (data) =>
  request("/api/lines", { method: "POST", body: data });
export const updateLine = (id, data) =>
  request(`/api/lines/${id}`, { method: "PUT", body: data });
export const deleteLine = (id) =>
  request(`/api/lines/${id}`, { method: "DELETE" });

// Processes
export const getProcesses = (lineId) =>
...
export const deleteProcess = (id) =>
  request(`/api/processes/${id}`, { method: "DELETE" });
...
export const createTray = (data) =>
  request("/api/trays", { method: "POST", body: data });
export const updateTray = (id, data) =>
  request(`/api/trays/${id}`, { method: "PUT", body: data });
export const deleteTray = (id) =>
  request(`/api/trays/${id}`, { method: "DELETE" });
...
export const createLog = (data) =>
  request("/api/logs", { method: "POST", body: data });
export const updateLog = (id, data) =>
  request(`/api/logs/${id}`, { method: "PUT", body: data });
