# 🏭 Lite MES — Dynamic Production Tracker

**Lite MES (Manufacturing Execution System)** คือระบบติดตามการผลิตแบบ Dynamic สำหรับโรงงานอุตสาหกรรม ออกแบบมาให้มีน้ำหนักเบา (Lightweight) ทำงานผ่านคลาวด์/เว็บเบราว์เซอร์ และเน้นประสบการณ์การใช้งาน (UX/UI) ที่ดีเยี่ยม โดยเฉพาะสำหรับผู้ปฏิบัติงานหน้างาน (Operators) ที่ใช้งานผ่านแท็บเล็ตหรือสมาร์ทโฟน
